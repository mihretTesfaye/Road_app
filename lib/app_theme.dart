...
class AppTheme {
  // Palette inspired by Figma: warm beige background, deep purple primary,
  // soft pink surfaces and orange accent for highlights.
  ...
  static const Color backgroundBeige = Color(0xFFF6EEE9); // app background
  static const Color surfaceRose = Color(0xFFF9ECE8); // card/panel surface
  static const Color white = Color(0xFFFFFFFF);

  // Backwards-compatible aliases for previously used names
  ...
  // Keep string aliases for any code expecting font family names
